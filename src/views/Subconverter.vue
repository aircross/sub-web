        ...
        remoteConfig: [
          {
            label:"ACL4SSR",
            options:[
              {label:"ACL4SSR 全分组自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full.ini"},
              {label:"ACL4SSR 全分组无自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full_NoAuto.ini"},
              {label:"ACL4SSR 精简分组自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Mini.ini"},
              {label:"ACL4SSR 精简分组无自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_Online_Mini_NoAuto.ini"},
              {label:"ACL4SSR 默认分组自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR.ini"},
              {label:"ACL4SSR 默认分组无自动测速",value:"https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/config/ACL4SSR_NoAuto.ini"},
              {label:"ACL4SSR_Online 默认版 分组比较全 (与Github同步)",value:"https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini"},{label:"ACL4SSR_Online_AdblockPlus 更多去广告 (与Github同步)",value:"https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_AdblockPlus.ini"},
